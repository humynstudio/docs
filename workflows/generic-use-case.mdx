...
aiSummary: "Follow this foundational workflow to frame a mission, ingest sources, cluster insights, and share decisions." 
---
...
| --- | --- | --- |
| ~45 minutes | Cross-functional teams getting started | First curated dataset, summary notes, action list |
...
1. Open [Explore](/core-features/explore) once ingestion finishes.  
...
- Use [Chat with Hue](/core-features/chat-with-hue) to generate a crisp summary that ties your pinned themes together.  
...
- Log follow-up questions that surfaced during reviews and feed them into the next prompt batch.  
- Schedule the next intake cycle and adjust keywords or URLs based on what resonated.  
- Track downstream impact (tickets resolved faster, demo win rate, roadmap decisions) so Humyn’s value stays visible.

<Callout>
Want to specialize this workflow? Pair it with the <a href="/workflows/product-managers">Product Managers, Designers & Researchers</a> or <a href="/workflows/analysts">Analysts and Traders</a> playbooks to tailor deliverables without redoing setup.
</Callout>

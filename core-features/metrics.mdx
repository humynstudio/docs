...
- Visualize the data on the [Dashboard](/core-features/dashboard).  
- Investigate anomalies inside [Explore](/core-features/explore).  
- Generate narrative-ready summaries with [Chat with Hue](/core-features/chat-with-hue).

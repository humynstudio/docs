...
- Feed chart-ready insights into [Dashboard](/core-features/dashboard).  
- Quantify impact in [Metrics](/core-features/metrics).  
- Generate conversational follow-ups with [Chat with Hue](/core-features/chat-with-hue).

...
![Humyn dashboard overview](/screenshots/project_dashboard.png)
...
- Build a measurement layer in [Metrics](/core-features/metrics).  
- Dive deeper into raw conversations via [Explore](/core-features/explore).  
- Ask follow-up questions with [Chat with Hue](/core-features/chat-with-hue).

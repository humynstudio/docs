...
Humyn leans on calm gradients, rounded corners, and generous white space. Use the assets in this repo to keep docs, marketing, and product training surfaces aligned.
...
- `/logo/light.svg` and `/logo/dark.svg`: Official Humyn mark (dark/light variants).
- `/svg logos/`: Original exports if you need to create new sizes.
- `/assets/landing-page.png`: Legacy docs hero saved for campaigns and slide decks.
- `/assets/metrics-mockup.png`: Metrics feature mockup for documentation and enablement.
- `/assets/demo-video.mp4`: Overview walkthrough for onboarding or marketing use.
- `/screenshots/`: Product screenshots for core feature docs (dashboard, Explore, Hue chat, and more).
...
## Video & motion placeholders

- Store Loom or Framer embeds under `/videos` (create if needed) with descriptive filenames like `community-scan-demo.mp4`.
- Document aspect ratios and durations so editors keep landing pages consistent.
- Capture thumbnail images and save them alongside the video for use in cards or embeds.
